...
export function MobileNavigation() {
  ...
  return <details className="mobile-navigation" ref={ref} onKeyDown={e=>{if(e.key==='Escape'&&ref.current){ref.current.open=false;ref.current.querySelector('summary')?.focus();}}}><summary aria-label="Open navigation"><Menu size={20}/></summary><nav aria-label="Mobile navigation" onClick={()=>{if(ref.current)ref.current.open=false;}}><Link href="/generator">QR Studio</Link><Link href="/designs">My designs</Link><Link href="/links">Dynamic links</Link><Link href="/content">Hosted content</Link><Link href="/scan-lab">Scan Lab</Link><Link href="/templates">Artwork library</Link><Link href="/brand-studies">Brand studies</Link><Link href="/docs">How it works</Link><Link href="/account">Your account</Link><Link href="/billing">Billing</Link></nav></details>;
}
