...
export default function DesignLibrary() {
  ...
  function open(item: SavedDesign, revision?: SavedRevision) { workflow.setDesign({ ...(revision?.draft || item.draft), name: item.name }, null, item.id); router.push('/generator?resume=1'); }
