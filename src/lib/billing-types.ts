...
export type BillingStatus = {configured:boolean;signedIn:boolean;plans:BillingPlan[];subscription:null|{tier:BillingTier;status:string;cancelAtPeriodEnd:boolean;scheduledCancellationAt:number|null;currentPeriodEnd:number};canManage:boolean;entitlement?:Entitlement};
